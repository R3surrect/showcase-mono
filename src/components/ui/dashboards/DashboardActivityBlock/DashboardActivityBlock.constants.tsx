...
export const chartsData: Partial<LineProps>[] = [
    { dataKey: "all", name: "Всего", stroke: "var(--cold-blue-grey-400)" },
    { dataKey: "completed", name: "Выполнено", stroke: "var(--warm-green-500)", dot: { r: 3, fill: 'var(--warm-green-500)' } },
    { dataKey: "outdated", name: "Просрочено", stroke: "var(--warm-red-400)", strokeDasharray: "4 3" },
]