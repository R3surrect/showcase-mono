...
import type { tagCreateClientPayloadSchema, tagCreateValidation } from "./validations/tag.create.js";
...
export type TagCreateClientPayload = z.infer<typeof tagCreateClientPayloadSchema>
